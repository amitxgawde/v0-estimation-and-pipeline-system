          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium text-foreground">${order.amount.toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-success">Received</span>
                <span className="text-sm font-medium text-success">${order.paymentReceived.toLocaleString()}</span>
              </div>
